...
public
abstract class Heroes extends Observable implements Visitable {
    private boolean killedByAngel = false;
    private float externModifiers;
    ...
    public final float getExternModifiers() {
        return externModifiers;
    }

    public final void setExternModifiers(final float externModifiers) {
        this.externModifiers = externModifiers;
    }
